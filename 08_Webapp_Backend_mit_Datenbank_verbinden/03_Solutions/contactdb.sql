...
CREATE TABLE `customer` (
  ...
  `subject` varchar(50) NOT NULL, -- subject varchar(50) NOT NULL,
  `description` varchar(500) NOT NULL, -- subject varchar(50) NOT NULL,
  `phone` varchar(20) default NULL, -- subject varchar(20) NOT NULL,
